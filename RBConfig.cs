...
namespace ReikaKalseki.Reefbalance
{
	...
	{		
		public enum ConfigEntries {
			...
			[ConfigEntry("Vegetable-Based food spoilage start delay (days)", typeof(float), 0.75F, 0, 100, 1)]FOOD_DELAY_VEG,
			[ConfigEntry("Meat-Based food spoilage start delay (days)", typeof(float), 0.25F, 0, 100, 1)]FOOD_DELAY_MEAT,
			[ConfigEntry("Generic food spoilage start delay (days)", typeof(float), 0.5F, 0, 100, 1)]FOOD_DELAY,
